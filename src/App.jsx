...
const App = () => {
    ...
    return (
        <>
            ...
            <section className="aboutMe" id="appSection1" ref={visorRefs[1]}>
            ...
            <section className="skills" id="appSection2" ref={visorRefs[2]}>
                <p>My skills</p>
                <div >
            ...
            <section className="proyects" id="appSection3" ref={visorRefs[3]}>
                <p>My proyects</p>
                <div>
                    <section>
                        <ProyectComponent />
            ...
            <section className="contact" id="appSection4" ref={visorRefs[4]}>
